        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                ...
                using React 18, Next.js, and Vue.js.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Designing robust APIs and microservices. Specialist in .NET Core,
                Node.js, and cloud-ready architectures with high availability.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
